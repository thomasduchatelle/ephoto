...
func (p *Parser) parseMVHD(details *backup.MediaDetails, payload []byte) {
	version := payload[0]
...
func (p *Parser) parseTKHD(details *backup.MediaDetails, buffer []byte) {
	version := buffer[0]
...
func (p *Parser) parseUDTA(details *backup.MediaDetails, payload []byte) {
