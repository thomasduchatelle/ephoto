...
import (
	...
	ui2 "github.com/thomasduchatelle/ephoto/cmd/dphoto/cmd/ui"
...
type ScanProgress struct {
	...
	scanningLine     *screen2.ProgressLine
	analysedLine     *screen2.ProgressLine
...
func newScanProgress() *ScanProgress {
	...
	scanningLine, scanningSegment := screen2.NewProgressLine(table, "Scanning...")
	analysedLine, analysedSegment := screen2.NewProgressLine(table, "Analysing...")

	progressScreen := screen2.NewAutoRefreshScreen(
